...
**新功能必須同步新增對應斷言**（selftest 目前 102 項）。自測不可只靠截圖：必須含真實
...
材質（玻璃/洞洞板/不鏽鋼）｜圓弧角（f.rc 指定角落半徑、3D 頂底面+2D path）｜
擬真外皮圓形（addBox 第9參數 rr；電鍋頂蓋固定不鏽鋼色）｜
櫃內物品編輯（顏色欄＋尺寸超界禁止還原警示＋放置格選取顯示內徑標示扣板厚）｜
